...
ggsave("~/Dropbox/research/atacseq/bulk/plots/realDataBenchmarkScoreRanks.pdf", width=12, height=12)
...
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_noRUV.pdf")
```
...
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_RUV1.pdf")
```
...
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_RUV2.pdf")
```
...
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_RUV3.pdf")
...
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_RUV4.pdf")
...
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_RUV5.pdf")
```
