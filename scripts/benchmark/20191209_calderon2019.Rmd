...
h5File <- "/Users/koenvandenberge/tmp/normCounts_calderon2019.h5"
sconeFit <- sconeEvaluation(counts=counts, bio=bio, negcon=negcon, batch=batch, qc=qc, 
                ...
                hdf5file=h5File)
saveRDS(sconeFit, "~/Dropbox/research/atacseq/bulk/analysis/benchmarkNormalization/calderon2019_sconeFit.rds")
...
```{r}
file.remove(h5File)
saveRDS(scores, file="~/Dropbox/research/atacseq/bulk/analysis/benchmarkNormalization/calderon2019_scores.rds")
sessionInfo()
```
