...
scores <- lapply(scores, function(x) x[,!colnames(x) %in% c("rleGC_med","rleGC_iqr")])
...
# scoreVector <- do.call(c, scores)
# rankVector <- unlist(lapply(scores, rank))
# scoreDfLong <- data.frame(score=scoreVector,
#                           method=names(scoreVector),
#                           dataset=unlist(mapply(rep,datasets,unlist(lapply(scores,length)))),
#                           rank=rankVector)
...
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_noRUV_permuted_noGCRLE.pdf")
```
...
ggplot(scoreDfOrdered1, aes(y=methodShort, x=dataset, fill=scaledRank)) + 
  ...
  theme(axis.text.x = element_text(angle = 30, vjust= 0.7, size=9),
        axis.text.y = element_text(size=9))
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_RUV1_permuted_noGCRLE.pdf")
```
...
ggplot(scoreDfOrdered2, aes(y=methodShort, x=dataset, fill=scaledRank)) + 
  ...
  theme(axis.text.x = element_text(angle = 30, vjust= 0.7, size=9),
        axis.text.y = element_text(size=9))
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_RUV2_permuted_noGCRLE.pdf")
```
...
ggplot(scoreDfOrdered3, aes(y=methodShort, x=dataset, fill=scaledRank)) + 
  ...
  theme(axis.text.x = element_text(angle = 30, vjust= 0.7, size=9),
        axis.text.y = element_text(size=9))
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_RUV3_permuted_noGCRLE.pdf")
...
ggplot(scoreDfOrdered4, aes(y=methodShort, x=dataset, fill=scaledRank)) + 
  ...
  theme(axis.text.x = element_text(angle = 30, vjust= 0.7, size=9),
        axis.text.y = element_text(size=9))
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_RUV4_permuted_noGCRLE.pdf")
...
ggplot(scoreDfOrdered5, aes(y=methodShort, x=dataset, fill=scaledRank)) + 
  ...
  theme(axis.text.x = element_text(angle = 30, vjust= 0.7, size=9),
        axis.text.y = element_text(size=9))
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_RUV5_permuted_noGCRLE.pdf")
```
