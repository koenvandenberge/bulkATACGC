---
title: "ATAC-seq normalization summary, polished, permuted GC content, no RLE"
...
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_noRUV_permuted_noRLE.pdf")
```
...
ggplot(scoreDfOrdered1, aes(y=methodShort, x=dataset, fill=scaledRank)) + 
  ...
  theme(axis.text.x = element_text(angle = 30, vjust= 0.7, size=9),
        axis.text.y = element_text(size=9))
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_RUV1_permuted_noRLE.pdf")
```
...
ggplot(scoreDfOrdered2, aes(y=methodShort, x=dataset, fill=scaledRank)) + 
  ...
  theme(axis.text.x = element_text(angle = 30, vjust= 0.7, size=9),
        axis.text.y = element_text(size=9))
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_RUV2_permuted_noRLE.pdf")
```
...
ggplot(scoreDfOrdered3, aes(y=methodShort, x=dataset, fill=scaledRank)) + 
  ...
  theme(axis.text.x = element_text(angle = 30, vjust= 0.7, size=9),
        axis.text.y = element_text(size=9))
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_RUV3_permuted_noRLE.pdf")
...
ggplot(scoreDfOrdered4, aes(y=methodShort, x=dataset, fill=scaledRank)) + 
  ...
  theme(axis.text.x = element_text(angle = 30, vjust= 0.7, size=9),
        axis.text.y = element_text(size=9))
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_RUV4_permuted_noRLE.pdf")
...
ggplot(scoreDfOrdered5, aes(y=methodShort, x=dataset, fill=scaledRank)) + 
  ...
  theme(axis.text.x = element_text(angle = 30, vjust= 0.7, size=9),
        axis.text.y = element_text(size=9))
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_RUV5_permuted_noRLE.pdf")
```
