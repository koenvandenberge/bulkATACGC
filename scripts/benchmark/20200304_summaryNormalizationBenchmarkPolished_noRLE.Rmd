...
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_noRUV_noRLE.pdf")
```
...
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_RUV1_noRLE.pdf")
```
...
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_RUV2_noRLE.pdf")
```
...
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_RUV3_noRLE.pdf")
...
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_RUV4_noRLE.pdf")
...
ggsave("~/Dropbox/research/atacseq/bulk/plots/benchmark_RUV5_noRLE.pdf")
```
